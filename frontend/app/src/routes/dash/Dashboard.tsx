  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="col-span-1 sm:col-span-1 bg-sky-600 text-white p-4 sm:p-5 rounded shadow min-w-0">
        ...
        <div className="col-span-1 sm:col-span-1 bg-emerald-600 text-white p-4 sm:p-5 rounded shadow min-w-0">
        ...
        <div className="col-span-1 sm:col-span-1 bg-amber-600 text-white p-4 sm:p-5 rounded shadow min-w-0">
